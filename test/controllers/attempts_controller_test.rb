...
class AttemptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attempt" do
    assert_difference('Attempt.count') do
      post attempts_url, params: { attempt: { attempt: @attempt.attempt, correct: @attempt.correct, gname: @attempt.gname, qid: @attempt.qid, score: @attempt.score, sname: @attempt.sname, uname: @attempt.uname } }
    end
  ...
  test "should update attempt" do
    patch attempt_url(@attempt), params: { attempt: { attempt: @attempt.attempt, correct: @attempt.correct, gname: @attempt.gname, qid: @attempt.qid, score: @attempt.score, sname: @attempt.sname, uname: @attempt.uname } }
