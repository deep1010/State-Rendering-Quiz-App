...
class SubgenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subgenre" do
    assert_difference('Subgenre.count') do
      post subgenres_url, params: { subgenre: { gname: @subgenre.gname, name: @subgenre.name } }
    end
  ...
  test "should update subgenre" do
    patch subgenre_url(@subgenre), params: { subgenre: { gname: @subgenre.gname, name: @subgenre.name } }
